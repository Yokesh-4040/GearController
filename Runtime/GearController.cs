    ...
    public class GearController : MonoBehaviour
    {
        ...
        private void XAxisCalculation()
        {
            if (gearMovementAxis == GearMovementAxis.X || gearType == GearType.PlusLiver)
            {
                ...
                {
                    case >= XMaxAngle and < ThresholdMaxCheck:
                        ...
                        break;
                    case <= XMaxAngle - AxisThreshold:
                        Debug.Log("Resetting X");
                        reachedEndX_B = false;
                        reachedEndX_A = false;
                        break;
                    case <= 360 - XMaxAngle and > ThresholdMaxCheck:
        ...
        private void ZAxisCalculation()
        {
            if (gearMovementAxis == GearMovementAxis.Z || gearType == GearType.PlusLiver)
            {
                ...
                {
                    case >= ZMaxAngle and < ThresholdMaxCheck:
                    ...
                    case <= ZMaxAngle - AxisThreshold:
                        Debug.Log("Resetting Z");
                        reachedEndZ_B = false;
                        reachedEndZ_A = false;
                        break;

                    case <= 360 - ZMaxAngle and > ThresholdMaxCheck:
